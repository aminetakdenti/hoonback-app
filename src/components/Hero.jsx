...
const Hero = () => (
  <section id="home" className={`flex flex-col md:flex-row ${styles.paddingY}`}>
    ...
    >
      ...
      <div>
        <h1 className="w-full flex-1 font-poppins text-[52px] font-semibold leading-[75px] text-white ss:text-[68px] ss:leading-[100px]">
          Payment Method.
        </h1>
        <p className={`${styles.paragraph} mt-5 max-w-[470px]`}>
          Our team of ecperts uses a mehodology to indetify the credit cards
    ...
    <div className={`flex flex-1 ${styles.flexCenter} relative md:my-0`}>
      <img src={robot} alt="billing" className="relative z-10 h-full w-full" />
      <div className="pink__gradient absolute top-0 z-0 h-[35%] w-[40%] " />
      <div className="pink__gradient white__gradient absolute  bottom-40 z-[1] h-[80%] w-[80%] rounded-full " />
      <div className="pink__gradient absolute bottom-20 right-20 z-0 h-[50%] w-[50%] " />
    </div>
